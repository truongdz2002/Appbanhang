...
public class Adapter_product_mini extends  RecyclerView.Adapter<Adapter_product_mini.Adapter_product_homeViewHoder>{
    ...
    public Adapter_product_mini(Context context, ItemClickProduct itemClickproduct) {
    ...
    public Adapter_product_homeViewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_product_mini,parent,false);
    ...
    public class Adapter_product_homeViewHoder extends RecyclerView.ViewHolder
 {
     ...
     public Adapter_product_homeViewHoder(@NonNull View itemView) {
         super(itemView);
         img_product=itemView.findViewById(R.id.img_product_mini);
         tv_name_product=itemView.findViewById(R.id.name_product_mini);
         tv_spcial_price_product=itemView.findViewById(R.id.special_price_product_mini);
         tv_price_product=itemView.findViewById(R.id.price_product_mini);
     }
 }
}
